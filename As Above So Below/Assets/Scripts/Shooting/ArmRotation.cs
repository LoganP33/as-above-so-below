...
public class ArmRotation : MonoBehaviour
{
    ...
    void Update()
    {
        Vector3 difference = UnityEngine.Camera.main.ScreenToWorldPoint(Input.mousePosition) - transform.position; //Subtracting the position of the player from the mouse posistion
